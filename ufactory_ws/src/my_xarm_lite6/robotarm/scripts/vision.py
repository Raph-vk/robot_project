...
if __name__ == '__main__':
    ...
    locatie_object.pose.position = Point(x=0, y=0.0, z=0)
    locatie_object.pose.orientation = Quaternion(x=0, y=0.707, z=0.0, w=-0.707)

    type_object = Int32()
    type_object.data = 0  # 0=geel 1=paars 2=roze 3=wit
