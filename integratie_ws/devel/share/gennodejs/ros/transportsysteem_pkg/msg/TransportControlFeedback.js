...
class TransportControlFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TransportControlFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TransportControlFeedback(null);
...
module.exports = TransportControlFeedback;
