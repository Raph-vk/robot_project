...
"""autogenerated by genpy from transportsysteem_pkg/SystemControlActionResult.msg. Do not edit."""
import codecs
import sys
...
class SystemControlActionResult(genpy.Message):
  _md5sum = "e5f62eb2cecdccdb33834c1bf0d40a1c"
  _type = "transportsysteem_pkg/SystemControlActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','transportsysteem_pkg/SystemControlResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SystemControlActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = transportsysteem_pkg.msg.SystemControlResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = transportsysteem_pkg.msg.SystemControlResult()
